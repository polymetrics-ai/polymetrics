...
const ConnectorCard: React.FC<ConnectorCardProps> = ({ name, icon, isActive, handleOnSelection}) => {
    return (
        <TooltipProvider delayDuration={100}>
            <Tooltip>
                <TooltipTrigger>
                    <div className={`flex gap-2.5 items-center p-4 border border-solid border-slate-300 min-h-[80px] min-w-[220px] shadow-[0px_3px_8px_-2px_rgba(203,213,225,0.60)] ${isActive ? 'bg-slate-300' : 'bg-white'}`} onClick={handleOnSelection}>
