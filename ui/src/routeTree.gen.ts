...
const AuthenticatedDashboardIndexLazyImport = createFileRoute('/_authenticated/dashboard/')();
const AuthenticatedConnectorsIndexLazyImport = createFileRoute('/_authenticated/connectors/')();
const AuthenticatedConnectionsIndexLazyImport = createFileRoute('/_authenticated/connections/')();
const AuthenticatedChartsIndexLazyImport = createFileRoute('/_authenticated/charts/')();
...
const AuthenticatedDocumentationIndexLazyRoute = AuthenticatedDocumentationIndexLazyImport.update({
    path: '/documentation/',
    getParentRoute: () => AuthenticatedRoute
} as any).lazy(() =>
    import('./routes/_authenticated/documentation/index.lazy').then((d) => d.Route)
);

const AuthenticatedDashboardIndexLazyRoute = AuthenticatedDashboardIndexLazyImport.update({
    path: '/dashboard/',
    getParentRoute: () => AuthenticatedRoute
} as any).lazy(() => import('./routes/_authenticated/dashboard/index.lazy').then((d) => d.Route));

const AuthenticatedConnectorsIndexLazyRoute = AuthenticatedConnectorsIndexLazyImport.update({
    path: '/connectors/',
    getParentRoute: () => AuthenticatedRoute
} as any).lazy(() => import('./routes/_authenticated/connectors/index.lazy').then((d) => d.Route));

const AuthenticatedConnectionsIndexLazyRoute = AuthenticatedConnectionsIndexLazyImport.update({
    path: '/connections/',
    getParentRoute: () => AuthenticatedRoute
} as any).lazy(() => import('./routes/_authenticated/connections/index.lazy').then((d) => d.Route));

const AuthenticatedChartsIndexLazyRoute = AuthenticatedChartsIndexLazyImport.update({
    path: '/charts/',
    getParentRoute: () => AuthenticatedRoute
} as any).lazy(() => import('./routes/_authenticated/charts/index.lazy').then((d) => d.Route));
